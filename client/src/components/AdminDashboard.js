...
function AdminDashboard(props) {
    ...
    return (
      ...
      <a href="/answerfaq"><button type="button" class="btn btn-success btn-lg" style={{margin:'10px',padding:'50px'}}>FAQ</button></a>
      ...
      <button onClick={outhandler} type="button" class="btn btn-success btn-lg" style={{margin:'10px',padding:'50px'}}>Logout</button>
      </div>
